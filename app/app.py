...
otlp_span_exporter = OTLPSpanExporter(
    ...
    # endpoint="http://10.0.0.217:5080/api/default/v1/traces",
    # headers=OPENOBSERVE_HEADERS,
)
...
otlp_metric_exporter = OTLPMetricExporter(
    endpoint="http://10.0.0.217:4317"
    # endpoint="http://10.0.0.217:5080/api/default/v1/metrics",
    # headers=OPENOBSERVE_HEADERS
)
...
#     endpoint="http://10.0.0.217:5080/api/default/v1/logs",
#     headers=OPENOBSERVE_HEADERS,
# )
